...
//    public void fillTourDetails(String tourType, int adult) {
//        tourPage.clickCalculatePrice();
//        //tourPage.selectTourType(tourType);
//      //  tourPage.setAdultCount(adult);
//        tourPage.selectTourType("Standard");
//        tourPage.setAdultCount(2);
//        ExtentManager.getTest().log(Status.INFO, "Selected Tour Type: " + tourType + ", Adult: " + adult);
//        ExtentManager.getTest().addScreenCaptureFromPath(
//                ScreenshotUtil.takeScreenshot(driver, "TourDetails")
//        );
//    }
/*   @When("user fills tour details with tour type {string}, {int} adults and date {string}")
////    public void user_fills_tour_details(String tourType, int adults, String date) {
////        // This will handle popup, click calculate price, select tour type/adults/date, and calculate
////        tourPage.fillTourDetails(tourType, adults, date);
   }*/
//
...
//        ExtentManager.getTest().addScreenCaptureFromPath(
//                ScreenshotUtil.takeScreenshot(driver, "TravelDate")
//        );
//    }
//
...
//        ExtentManager.getTest().log(Status.INFO, "Filled Contact Details Mobile: " + mobile + ", Email: " + email);
//        ExtentManager.getTest().addScreenCaptureFromPath(
//                ScreenshotUtil.takeScreenshot(driver, "ContactDetails")
//        );
//    }
//
//    @When("I sign in with {string} and continue as guest")
//    public void loginGuest(String email) {
//        tourPage.loginGuest(email);
//        ExtentManager.getTest().log(Status.INFO, "Signed in with email and continued as guest: " + email);
//        ExtentManager.getTest().addScreenCaptureFromPath(
//                ScreenshotUtil.takeScreenshot(driver, "LoginGuest")
//        );
//    }
//
...
//        ExtentManager.getTest().log(Status.INFO, "Filled Traveller 1: " + fName + " " + lName);
//        ExtentManager.getTest().addScreenCaptureFromPath(
//                ScreenshotUtil.takeScreenshot(driver, "Traveller1")
//        );
//    }
//
...
//        ExtentManager.getTest().log(Status.INFO, "Filled Traveller 2: " + fName + " " + lName);
//        ExtentManager.getTest().addScreenCaptureFromPath(
//                ScreenshotUtil.takeScreenshot(driver, "Traveller2")
//        );
//    }
//
//    @When("I fill Address details {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}")
//    public void fillAddress(String title, String fName, String lName, String addr, String state, String city, String pincode, String email, String mobile) {
//        tourPage.fillAddress(title, fName, lName, addr, state, city, pincode, email, mobile);
//        ExtentManager.getTest().log(Status.INFO, "Filled Address details for: " + fName + " " + lName);
//        ExtentManager.getTest().addScreenCaptureFromPath(
//                ScreenshotUtil.takeScreenshot(driver, "AddressDetails")
//        );
//    }
//
...
//        tourPage.fillPayment(cardNum, expM, expY, cvvNum, cardHolder);
//        ExtentManager.getTest().log(Status.INFO, "Filled Payment details for card holder: " + cardHolder);
//        ExtentManager.getTest().addScreenCaptureFromPath(
//                ScreenshotUtil.takeScreenshot(driver, "PaymentDetails")
//        );
//    }
//
...
//            ExtentManager.getTest().addScreenCaptureFromPath(
//                    ScreenshotUtil.takeScreenshot(driver, "PaymentFailed")
//            );
//        } else {
