...
//    By registerButton = By.xpath("//button[@id='registerButton']");
//    By errorMessages = By.xpath("//*[contains(@class,'error') or contains(text(),'invalid') or contains(text(),'required')]");
//
...
//        driver.findElement(loginToggle).click();
//    }
//
...
//            System.out.println("✅ Clicked Register button successfully");
//        } catch (Exception e) {
...
//                System.out.println("✅ Clicked Register button using JSExecutor");
//            } catch (Exception jsEx) {
//                System.out.println("❌ Even JS click failed: " + jsEx.getMessage());
//            }
//        }
//    }
//
